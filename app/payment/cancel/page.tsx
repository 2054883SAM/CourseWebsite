...
export default function PaymentCancelPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 text-center">
      ...
      <p className="mt-2 text-gray-600">Aucun frais n'a été prélevé. Vous pouvez réessayer à tout moment.</p>
      <div className="mt-8 flex items-center justify-center gap-3">
        <Link href="/payment" className="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">Réessayer</Link>
