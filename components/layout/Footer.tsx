              ...
              <div className="flex space-x-6 mb-6 md:mb-0" aria-label="Social media links">
                {socialLinks.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="text-gray-500 dark:text-gray-400 hover:text-gold-600 dark:hover:text-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 rounded-full p-1 transition-colors duration-200"
                    target="_blank"
