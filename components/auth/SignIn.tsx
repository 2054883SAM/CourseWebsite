...
export function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check for redirect URL in different places
      const redirectTo = searchParams.get('redirectTo') || // From middleware
                        sessionStorage.getItem('redirectAfterLogin') || // From client-side
                        '/'; // Default
